...
| 2026-03-22 | [ ] | Phase 1 — Entity CRUD (+ Experiment CRUD) | `provenance/api/v1/routes/entities.py`, `provenance/api/v1/routes/experiments.py`, `provenance/services/entity_service.py` |